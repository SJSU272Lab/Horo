...
CREATE TABLE `user_profile` (
  ...
  PRIMARY KEY (`user_fid`),
  UNIQUE KEY `user_fid_UNIQUE` (`user_fid`),
  CONSTRAINT `user_fid` FOREIGN KEY (`user_fid`) REFERENCES `user_master` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
