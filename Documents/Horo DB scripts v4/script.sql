...
INSERT INTO `course_details` VALUES (00000000001,12,1,'2016-01-01','2016-01-01',NULL,'English',10,NULL,'Nice coure'),(00000000002,14,1,'2016-01-01','2016-01-01',NULL,'Spanish',10,NULL,'Wow what a dude');
...
CREATE TABLE `course_master` (
  ...
  KEY `course_category_idx` (`course_category`),
  CONSTRAINT `course_category` FOREIGN KEY (`course_category`) REFERENCES `category_master` (`category_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `course_master` VALUES (1,'t',1),(2,'s',3),(3,'u',3),(11,'hello',2),(12,'v',2),(13,'Good course',2),(14,'Earn Money',3);
...
CREATE TABLE `course_progress` (
  ...
  CONSTRAINT `FK_course_id` FOREIGN KEY (`course_id`) REFERENCES `course_master` (`course_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `course_progress` VALUES (3,12,2,3),(4,14,2,5);
...
INSERT INTO `session` VALUES (1,14,'session',10,'1990-01-01 00:00:00','San Jose','asjdhasjd',NULL,NULL);
...
INSERT INTO `user_master` VALUES (1,'gaurangmhatre','volunteer','Fri Nov 25 2016 21:38:46 GMT-0800 (Pacific Standard Time)','$2a$10$SQkJELAYFwMhRKmiBXmsxe933a0Q.kI4zqObU0jTdGKwaWdNIaHCi'),(2,'jaynir','attendee','Fri Nov 25 2016 22:27:49 GMT-0800 (Pacific Standard Time)','$2a$10$Orvg6E9qCeOwXNGA6A4ydeO54nx5PgwjmGJ0WrqzxXeLsTZeyQGuK');
...
-- Dump completed on 2016-11-28 23:47:23
